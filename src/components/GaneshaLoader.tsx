      ...
      {visible && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center">
            ...
            {/* Luxury Loader Progress Bar & Button Container */}
            <div className="mt-12 h-16 flex items-center justify-center">
              <AnimatePresence mode="wait">
                {!isReady ? (
                  ...
                  >
                    <div className="h-[1.5px] w-48 overflow-hidden rounded-full bg-stone-900">
                      <motion.div
                        initial={{ width: "0%" }}
                        animate={{ width: "100%" }}
                    ...
                    <span className="text-[10px] uppercase tracking-[0.25em] text-stone-500 animate-pulse">
                  ...
                  <motion.button
                    ...
                    className="px-8 py-3.5 bg-gradient-to-r from-gold-dark via-gold to-gold-light text-black font-sans font-bold text-xs uppercase tracking-[0.2em] rounded-full shadow-lg cursor-pointer flex items-center gap-2"
                  >
                    Open Invitation
                    <svg 
                      className="w-4 h-4" 
