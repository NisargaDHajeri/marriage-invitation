...
export default function AudioPlayer({ isVisible = true }: AudioPlayerProps) {
  const audioRef = useRef<HTMLAudioElement | null>(null);
  const [isPlaying, setIsPlaying] = useState(false);
  const [hasInteracted, setHasInteracted] = useState(false);

  // Audio source list for high reliability (Primary: Aaj Sajeya, Secondary/Fallback: Classical Bansuri flute)
  const audioSources = [
    "https://pagalnew.com/download128/6760",
    "https://pagalnew.com/download320/6760",
    "https://pagalnew.com/128-downloads/6760",
    "https://upload.wikimedia.org/wikipedia/commons/3/30/Bansuri_Raga_Yaman.ogg" // elegant instrumental fallback
  ];
